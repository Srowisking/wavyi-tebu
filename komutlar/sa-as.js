...
if(args[0] === 'aç') {
    ...
    message.channel.send('Başarılı Bir Şekilde SA-AS Sistemi `Açıldı!` <a:srowdoru:733997295384789023>')
      db.set(`saas_${message.guild.id}`, "acik")
  return
}
if (args[0] === 'kapat') {
  db.delete(`saas_${message.guild.id}`)
message.channel.send('Başarılı Bir Şekilde SA-AS Sistemi `Kapatıldı!` <a:srowdoru:733997295384789023>')
